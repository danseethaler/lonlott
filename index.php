            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="site-heading">
                        ...
                        <hr class="small">
                        <span class="subheading">Lon Lott for Alpine City Council</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <div class="post-preview">
                    <a href="posts/alpine-parade.php">
                        ...
                        <h3 class="post-subtitle">
                            The opportunity to meet for the Parade is a tradition our family has enjoyed for years.
                        </h3>
                    </a>
                ...
                <div class="post-preview">
                    ...
                    <p class="post-meta">Posted by <a href="#">Lon Lott 4 Alpine</a> on September 18, 2014</p>
                </div>
                <hr>
                <div class="post-preview">
                    <a href="post.php">
                    ...
                    <p class="post-meta">Posted by <a href="#">Lon Lott 4 Alpine</a> on August 24, 2014</p>
                </div>
                <hr>
                <div class="post-preview">
                    <a href="post.php">
